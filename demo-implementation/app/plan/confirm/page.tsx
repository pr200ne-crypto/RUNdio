...
function PlanConfirmContent() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-slate-50 text-slate-800 pb-24 shadow-2xl relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent z-20">
        <div className="w-full">
          <Link
            href={`/run/active?routeId=${routeId}&poiId=${poiId}&poiName=${encodeURIComponent(poi.name)}`}
