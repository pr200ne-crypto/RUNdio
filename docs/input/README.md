...
> **別エージェント／次回チャット用**: 先に [`../AGENT_HANDOFF.md`](../AGENT_HANDOFF.md) と [`../continuation-checkpoint-2026-04-04.md`](../continuation-checkpoint-2026-04-04.md) を読むこと（続き・NotebookLM 音声・並行作業は後者）。

## 概要

**ランディオ**は、走る前のプランニングから走行中の**あなた専用のランニング用ラジオ**、走後の振り返り・次回提案までを一続きで届けるプロダクトの要件入力です。  
...
| [../continuation-checkpoint-2026-04-04.md](../continuation-checkpoint-2026-04-04.md) | **エージェント続き用**（2026-04-04 時点・NotebookLM 含む） |
